...
INSERT INTO `linkis_ps_dm_datasource_env`
    (`env_name`, `env_desc`, `datasource_type_id`, `parameter`, `create_time`, `create_user`, `modify_time`, `modify_user`)
VALUES ('测试环境SIT', '测试环境SIT', @data_source_type_id, '{"uris":"@HIVE_METASTORE_URIS", "hadoopConf":{"hive.metastore.execute.setugi":"true"}}',  now(), NULL,  now(), NULL);

select @data_source_type_id := id from `linkis_ps_dm_datasource_type` where `name` = 'kafka';
INSERT INTO `linkis_ps_dm_datasource_env`
    (`env_name`, `env_desc`, `datasource_type_id`, `parameter`, `create_time`, `create_user`, `modify_time`, `modify_user`)
VALUES ('kafka测试环境SIT', '开源测试环境SIT', @data_source_type_id, '{"uris":"localhost:9092"}',  now(), NULL,  now(), NULL);

select @data_source_type_id := id from `linkis_ps_dm_datasource_type` where `name` = 'iceberg';
INSERT INTO `linkis_ps_dm_datasource_env`
    (`env_name`, `env_desc`, `datasource_type_id`, `parameter`, `create_time`, `create_user`, `modify_time`, `modify_user`)
VALUES ('测试环境iceberg', '测试环境iceberg', @data_source_type_id, '{"uris":"@HIVE_METASTORE_URIS", "hadoopConf":{"hive.metastore.execute.setugi":"true"}}', now(), NULL, now(), NULL);
